...
const rawApiEndpoint = process.env.NEXT_PUBLIC_API_ENDPOINT || 'https://api.onlinewardleymaps.com/v1/maps/';

export const ApiEndpoint = rawApiEndpoint.endsWith('/') ? rawApiEndpoint : `${rawApiEndpoint}/`;
